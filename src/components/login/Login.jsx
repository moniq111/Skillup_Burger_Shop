 ...
 import {MDBContainer, MDBTabs, MDBTabsItem, MDBTabsLink, MDBTabsContent, MDBTabsPane, MDBBtn,
    ...
    return (
        <MDBContainer className="p-3 my-5 d-flex flex-column w-50">
            ...
            <MDBInput wrapperClass="mb-4"label="Dirección de correo electrónico" id="form1"type='email'/>
            ...
            <p className="text-center"> ¿No estás registrado? <a href="#!">Regístrate</a></p>
        </MDBTabsPane>
        <MDBTabsPane show={justifyActive === 'tab2'}>
         ...
         <p className="text-center mt-3">or:</p>
            ...
            <MDBInput wrapperClass="mb-4"label="Nombre de usuario" id="form1"type="text"/>
            <MDBInput wrapperClass="mb-4" label="Dirección de correo electrónico" id="form1" type="email" />
            <MDBInput wrapperClass="mb-4" label="Contraseña" id="form1" type="password"/>
    
        <div className="d-flex justify-content-center mb-4">
           <MDBCheckbox name="flexCheck" id="flexCheckDefault"label="He leído y acepto las condiciones"/>
        </div>
